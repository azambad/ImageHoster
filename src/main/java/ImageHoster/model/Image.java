...
public class Image {
    ...
    //The attribute contains a list of all comments on an image
    //Note that no column will be generated for this attribute in the Image table
    //Since the mapping is one to Many, Comment entity is having Many to one join on Image entity and this will help to load comment related data.
